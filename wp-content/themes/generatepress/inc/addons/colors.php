...
if ( !function_exists('generate_get_color_defaults') && !function_exists('generate_advanced_css') ) :
	...
	function generate_get_color_defaults()
	{
		$generate_color_defaults = array(
			...
			'navigation_background_color' => '#D5C5B8',
			'navigation_text_color' => '#0C1624',
			'navigation_background_hover_color' => '#0C1624',
			'navigation_text_hover_color' => '#FFFFFF',
			'navigation_background_current_color' => '#0C1624',
			'navigation_text_current_color' => '#FFFFFF',
			'subnavigation_background_color' => '#0C1624',
			'subnavigation_text_color' => '#FFFFFF',
			'subnavigation_background_hover_color' => '#D5C5B8',
			'subnavigation_text_hover_color' => '#0C1624',
			'subnavigation_background_current_color' => '#D5C5B8',
			'subnavigation_text_current_color' => '#0C1624',
